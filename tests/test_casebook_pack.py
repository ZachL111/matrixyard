"""Regression checks for the matrixyard casebook."""
...
from casebook.harness import assert_expected, matrixyard_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(matrixyard_summary(), assert_expected())
